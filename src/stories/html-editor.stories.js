...
import HtmlEditorView from "../components/html-editor-view";

export default {
  title: "Example/HTML Editor",
...
export const HtmlEditorViewComponent = () => {
  const htmlContent =
  ...
  return <HtmlEditorView value={htmlContent} />;
};

HtmlEditorViewComponent.story = {
  name: "Viewer"
};
